              ...
              <div className="space-y-1 sm:space-y-3">
                ...
                <div className="space-y-1">
                  ...
                  <motion.p 
                    ...
                    className="text-sm sm:text-lg lg:text-xl font-medium leading-relaxed max-w-2xl whitespace-pre-line text-center sm:text-left text-muted-foreground text-pretty"
                  >
          ...
          >
            {dadosCliente.depoimentos.map((depoimento, index) => (
              <motion.div
                ...
                whileHover={{ y: -6 }}
                className="card-premium card-topline relative group overflow-hidden rounded-2xl p-6 sm:p-8"
              >
                <div className="relative z-10">
                  <Quote
                    className="absolute -top-1 right-0 h-8 w-8 opacity-15"
                  ...
                  <div className="flex items-center gap-4 mb-4">
                    <Image
                      ...
                      width={56}
                      height={56}
                      className="rounded-full w-14 h-14 object-cover border-2 transition-transform duration-300 group-hover:scale-105"
